...
function build_runtime() {
	...
	// 加载常量定义文件
    require CORE_PATH.'/VThink/defines.php';

	// 加载路径定义文件
    require CORE_PATH.'/VThink/paths.php';

	// 定义核心编译的文件
    $runtime[]  =  CORE_PATH.'/VThink/functions.php';	// 系统函数
    ...
    if(is_file(CONFIG_PATH.'core.php')) {
        ...
        // 加载核心编译文件
        $list   =  include CORE_PATH.'/VThink/core.php';
    }
    ...
    if (RUNTIME_ALLINONE || !NO_CACHE_RUNTIME) {
        ...
        $content	=	compile(CORE_PATH.'/VThink/defines.php',$compile);
        $content	.=	compile(CORE_PATH.'/VThink/paths.php',$compile);
